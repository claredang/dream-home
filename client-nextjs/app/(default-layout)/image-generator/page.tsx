...
export default function ImageGenerator() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("full customize: ", fullPrompt);
  ...
  return (
    <div class="gap-1 px-5 flex flex-col md:flex-row flex-1 justify-center py-5">
      <div class="layout-content-container flex flex-col w-96">
        ...
        <div class="flex gap-3 p-3 flex-wrap pr-4">
          ...
          <button className="btn-yellow">
            <Link
              href="/quiz-test"
              target="_blank"
              //   class="bg-yellow-100 flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-xl pl-3 pr-3 cursor-pointer"
            >
              Quiz Your Style
            </Link>
          </button>
